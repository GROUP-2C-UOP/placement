...
from .models import Placement, CustomUser, Notifications, ToDoApplication
...
class ToDoApplicationSerializers(serializers.ModelSerializer):
    class Meta:
        model = ToDoApplication
        fields = [
            "id",
            "company",
            "role",
